    ...
    public partial class addInitialTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CommonDropown", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MusicSpecialization = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AspNetUsers_CommonDropown_GenderId",
                        column: x => x.GenderId,
                        principalTable: "CommonDropown",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DurationOfEvent = table.Column<TimeSpan>(type: "time", nullable: false),
                    ...
                    BookedUserId = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_BookingForm", x => x.Id);
                    table.ForeignKey(
                        name: "FK_BookingForm_AspNetUsers_BookedById",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserBookings_AspNetUsers_BookedById",
                        column: x => x.BookedById,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserBookings_AspNetUsers_BookedUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_BookingForm_BookedById",
                table: "BookingForm",
                column: "BookedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookings_BookedById",
                table: "UserBookings",
                column: "BookedById");

            migrationBuilder.CreateIndex(
                name: "IX_UserBookings_BookedUserId",
                table: "UserBookings",
                column: "BookedUserId");
        }
